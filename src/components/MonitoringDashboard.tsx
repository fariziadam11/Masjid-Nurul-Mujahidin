    ...
    <div className="min-h-screen bg-gray-50 py-4 sm:py-6 lg:py-8">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">{currentContent.title}</h1>
        ...
        <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row gap-3 sm:gap-4">
          <button
            ...
            className="bg-emerald-600 text-white px-3 sm:px-4 py-2 sm:py-3 rounded-md hover:bg-emerald-700 transition-colors flex items-center justify-center space-x-2 text-sm sm:text-base"
          >
          ...
          <button
            ...
            className="bg-red-600 text-white px-3 sm:px-4 py-2 sm:py-3 rounded-md hover:bg-red-700 transition-colors flex items-center justify-center space-x-2 text-sm sm:text-base"
          >
        ...
        <div className="mb-4 sm:mb-6">
          <nav className="flex overflow-x-auto space-x-2 sm:space-x-4 lg:space-x-8 pb-2">
            {[
              ...
              return (
                <button
                  ...
                  className={`flex items-center space-x-1 sm:space-x-2 px-2 sm:px-3 py-2 rounded-md transition-colors whitespace-nowrap text-sm sm:text-base ${
                    activeTab === tab.id
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                  <p className="text-xs sm:text-sm font-medium text-gray-600 truncate">{currentContent.totalLogs}</p>
                  <p className="text-xl sm:text-2xl font-bold text-gray-900">{analytics.totalLogs || 0}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                  <p className="text-xs sm:text-sm font-medium text-gray-600 truncate">{currentContent.totalErrors}</p>
                  <p className="text-xl sm:text-2xl font-bold text-gray-900">{analytics.last24Hours?.errors || 0}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                  <p className="text-xs sm:text-sm font-medium text-gray-600 truncate">{currentContent.totalWarnings}</p>
                  <p className="text-xl sm:text-2xl font-bold text-gray-900">{analytics.last24Hours?.warnings || 0}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow">
              <div className="flex items-center">
                ...
                <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                  <p className="text-xs sm:text-sm font-medium text-gray-600 truncate">{currentContent.securityEvents}</p>
                  <p className="text-xl sm:text-2xl font-bold text-gray-900">{analytics.last24Hours?.securityEvents || 0}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'logs' && (
          <div className="bg-white rounded-lg shadow">
            <div className="p-4 sm:p-6 border-b border-gray-200">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">{currentContent.logs}</h3>
        ...
        {activeTab === 'performance' && (
          <div className="bg-white rounded-lg shadow">
            <div className="p-4 sm:p-6 border-b border-gray-200">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">{currentContent.performance}</h3>
            </div>
                ...
                <div className="p-4 sm:p-6 space-y-4">
                  {performanceMetrics.map((metric) => (
                    <div key={metric.id} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                      ...
                      <div className="space-y-2">
                        <p className="text-lg font-bold text-gray-900">{metric.value.toFixed(2)} {metric.unit}</p>
                        <pre className="text-xs bg-white p-2 rounded border overflow-x-auto">
                          {JSON.stringify(metric.details, null, 2)}
                        </pre>
                      </div>
        ...
        {activeTab === 'security' && (
          <div className="bg-white rounded-lg shadow">
            <div className="p-4 sm:p-6 border-b border-gray-200">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">{currentContent.security}</h3>
                    ...
                    <div key={event.id} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                      ...
                      <div className="space-y-2">
                        <p className="text-sm text-gray-900">
                          <span className="font-medium">User:</span> {event.userEmail || event.userId || 'Anonymous'}
                        </p>
                        <pre className="text-xs bg-white p-2 rounded border overflow-x-auto">
                          {JSON.stringify(event.details, null, 2)}
                        </pre>
